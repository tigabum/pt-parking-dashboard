...
export function StatCard({ icon, label, value, change, description }: StatCardProps) {
  return (
    <Card className="relative overflow-hidden border-0 bg-white/40 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:bg-white/60 transition-all duration-500 group rounded-3xl ring-1 ring-slate-200/50">
      ...
      <CardContent className="p-5 pt-0 space-y-2 relative">
        ...
        <div className="flex items-center justify-between gap-2">
          <p className="text-[11px] text-slate-500 font-bold tracking-tight line-clamp-1">{description}</p>
