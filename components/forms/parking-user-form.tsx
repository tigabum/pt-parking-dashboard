...
export function ParkingUserForm({
    ...
    const getCategoryIcon = (category: string) => {
        switch (category) {
            case "Booking Operations": return <Calendar className="h-4 w-4" />;
            case "Customer & Vehicle": return <UserSquare className="h-4 w-4" />;
            case "Financial & Wallet": return <Wallet className="h-4 w-4" />;
            case "Dashboard & Reports": return <LayoutDashboard className="h-4 w-4" />;
            case "Reviews Management": return <Star className="h-4 w-4" />;
                                ...
                                <div className="space-y-6 pt-6 border-t border-slate-100">
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            ...
                                            <Select value={parkingId} onValueChange={(val) => {
                                                setParkingId(val);
                                            ...
                                            {selectedParking && (
                                                <div className="p-3 bg-white rounded-xl border border-primary/10 shadow-sm flex items-center gap-3">
                                                    ...
                                                    <div className="overflow-hidden">
                                                        <p className="text-[11px] font-black text-primary uppercase leading-tight">{selectedParking.name}</p>
                                                        <p className="text-[10px] text-slate-400 font-medium truncate italic">{selectedParking.city}</p>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
