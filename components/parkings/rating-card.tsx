...
export function RatingCard({
  ...
  if (submitted) {
    return (
      <div className="bg-emerald-50 p-8 rounded-4xl border border-emerald-100 flex flex-col items-center text-center gap-3 animate-in zoom-in-95 duration-500">
  ...
  return (
    <div className="bg-slate-50 p-6 sm:p-8 rounded-lg border border-slate-100 space-y-6">
      <div className="text-center space-y-1">
        <h3 className="text-xl font-black text-slate-900 tracking-tight">
          Rate your Experience
        </h3>
        <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">
          How was your stay at {parkingName}?
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <Textarea
          ...
          className="min-h-25 rounded bg-white border-slate-100 focus:ring-primary/10 transition-all font-medium text-slate-900 p-4 text-sm placeholder:text-slate-300 placeholder:text-xs"
        />
      </div>
      ...
      <Button
        ...
        className="w-full h-14 rounded-2xl bg-primary text-white font-black uppercase tracking-[0.2em] transition-all active:scale-95 border-none text-[10px] shadow-xl shadow-slate-200 flex items-center justify-center gap-3"
      >
        {submitting ? (
