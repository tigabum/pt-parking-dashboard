...
export function RatingDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-112.5 rounded-lg p-0 overflow-hidden border-none shadow-2xl bg-white">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              className="min-h-30 rounded-2xl bg-slate-50 border-none focus:ring-primary/10 transition-all font-medium text-slate-600 p-4"
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <Button
              ...
              className="w-full h-14 rounded-2xl bg-primary text-white font-black uppercase tracking-[0.2em] transition-all active:scale-95 border-none text-xs shadow-none"
            >
              {submitting ? (
