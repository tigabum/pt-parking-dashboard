...
"[project]/app/dashboard/parking-users/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditParkingUserPage() {
    ...
    const loadUser = async ()=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].getUserById(id);
            if (response && response.data) {
    ...
    const handleSave = async (data)=>{
        setSaving(true);
        const loadingToast = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading("Updating manager assignment...");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].updateUser(id, data);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err?.message || "Failed to update assignment", {
                id: loadingToast
            });
        } finally{
            setSaving(false);
...
_s(EditParkingUserPage, "t6btWvUlCmRopcHS4lAcUIh7Pus=", false, function() {
    return [
...
_c = EditParkingUserPage;
var _c;
__turbopack_context__.k.register(_c, "EditParkingUserPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_adb817df._.js.map