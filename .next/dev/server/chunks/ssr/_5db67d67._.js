...
function BookingActions({ row, onDetail, onConfirmPayment, onConfirmArrival }) {
    const { hasPermission } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const showConfirmPayment = row.paymentMethod === 'INCASH' && (row.status === 'PENDING' || row.status === 'COMPLETED') && hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PERMISSIONS"].BOOKING_UPDATE);
