    ...
    <DetailLayout
      ...
      actions={
        <div className="flex items-center gap-3">
          ...
          <Badge
            className={`h-10 px-5 rounded-xl flex items-center justify-center font-black uppercase text-[10px] tracking-widest border-none ${user.status === "ACTIVE"
          ...
          <DetailItem
            ...
            value={
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-sm">{String(user.email || "")}</span>
              </div>
            }
          />
          <DetailItem
        ...
        <DetailItem
          ...
          value={
            <Badge
              className={cn(
                "font-bold",
                user.isPasswordSet || user.isEmailVerified || user.isPhoneVerified
                  ? "bg-green-100 text-green-700"
