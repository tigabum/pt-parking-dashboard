        ...
        >
            <DetailSection title="Vehicle Detail">
                ...
                <div className="col-span-full mt-6">
                    <Label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 block">Owner Context</Label>
                    <div className="flex items-center gap-5 p-2 bg-slate-50 rounded-2xl border border-slate-100">
                        ...
                        <Button
                            ...
                            className="bg-white hover:bg-slate-50 text-slate-900 rounded-xl h-10 px-4 font-bold transition-all text-[10px] uppercase tracking-widest border border-slate-200 shadow-sm mr-4"
                        >
                            Profile
                        </Button>
                    </div>
