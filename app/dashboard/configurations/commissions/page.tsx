    ...
    const columns: Column<BookingCommission>[] = [
        {
            ...
            render: (row) => (
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono">ID: {row.id.split('-')[0]}...</span>
                </div>
            ),
        },
        {
            ...
            render: (row) => (
                <div className="flex flex-col">
                    <span className="font-bold text-slate-700">{row.parking?.name || "—"}</span>
                    <span className="text-[10px] text-slate-400 italic">{row.parking?.city || "Ethiopia"}</span>
                </div>
            ),
        },
        {
            ...
            render: (row) => (
                <span className="font-bold text-slate-600">{Number(row.totalAmount).toLocaleString()} ETB</span>
            ),
        },
        {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex items-center gap-5">
                    ...
                    <div className="space-y-0.5">
                        <p className="text-[10px] font-bold uppercase text-slate-400 tracking-wider font-mono">Total Transactions</p>
